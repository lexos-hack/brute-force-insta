...
#!/bin/bash
# https://t.me/unlimted_tech
# www.instagram.com/zano_security
...
printf "\n"
printf "\e[1;77m\e[41m  Don't forget to subscribe to our YouTube channel v1.0, Author: @skar44 (telegram)  \e[0m\n" #Don't change, noob
printf "\n"
}
